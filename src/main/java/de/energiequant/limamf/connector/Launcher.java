...
public class Launcher {
    ...
    public static final String APPLICATION_NAME = "LiMa-MF Flight Simulation Panel Connector";
    ...
    private static final String BROKEN_CLASSPATH_MESSAGE = "It looks like your Java class path may be broken.\n"
        + "If startup fails confirm that you do not run this application\n"
        + "from a path containing any directory ending in an\n"
        + "exclamation mark. Move the .jar file to another location\n"
